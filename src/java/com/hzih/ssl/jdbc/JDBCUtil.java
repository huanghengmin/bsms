...
import com.hzih.bsms.web.action.ra.RaConfigXml;
import java.sql.*;
import java.util.*;
...
InputStream in = new BufferedInputStream(*//*JDBCUtil.class.getResourceAsStream("/user_sql.properties")*//*new FileInputStream(Ra.file_path));
...
//            if(p!=null){
            String forName = RaConfigXml.getAttribute(RaConfigXml.jdbc_driverClass)/* p.getProperty("jdbc.driverClass")*/;
            if(forName!=null){
...
//            Properties p = getProperties();
//            if(p!=null){
            url = RaConfigXml.getAttribute(RaConfigXml.jdbc_url)/* p.getProperty("jdbc.url")*/;
            user = RaConfigXml.getAttribute(RaConfigXml.jdbc_user)/*p.getProperty("jdbc.user")*/;
            password =RaConfigXml.getAttribute(RaConfigXml.jdbc_password)/* p.getProperty("jdbc.password")*/;
//            }
