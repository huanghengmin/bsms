...
import com.hzih.bsms.domain.Site;
...
import com.hzih.bsms.web.servlet.SiteContextLoaderServlet;
 ...
 */
public class BsManagerConfigAction extends ActionSupport {
    ...
    private static final Logger logger = Logger.getLogger(BsManagerConfigAction.class);
    //    private String config_path = StringContext.systemPath+File.separator+"bsconfig"+File.separator+"bsMs.xml";
    ...
    //    private String nginx_path = StringContext.nginxPath + "/bsMs.conf";
//    private String nginx_path = StringContext.nginxConfigPath + "/bsMs.conf";
            ...
            if (protocol.equals("https")) {
                ...
                if (site != null) {
                    ...
                    try {
                        ...
                        httpsProcess.init(managerip, Integer.parseInt(managerport), proxyip, Integer.parseInt(proxyport), site.getCert_path(), site.getKey_path());
