...
//            String lines = linuxUtil.getLinuxByCommand("192.168.1.232", "root", "admin","cd /usr/local/nginx;./nginx;cd;ps -ef");
            CertUtils.execute("cd "+ StringContext.nginxSbin+";./nginx;");
    ...
    public String closeServe() throws IOException {
        ...
        try{
//            LinuxUtil linuxUtil = new LinuxUtil();
//            String lines = linuxUtil.getLinuxByCommand("192.168.1.232", "root", "admin","cd /usr/local/nginx;./nginx -s stop;cd;ps -ef");
