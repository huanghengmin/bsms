...
import com.hzih.bsms.dao.RoleUserDao;
import com.hzih.bsms.domain.RoleUser;
...
public class RoleUserDaoImpl extends HibernateDaoSupport implements  RoleUserDao{
    ...
    public ArrayList<RoleUser> findRoleUsersByRoleIdAndUserId(int roleid, int userid) {
        String hql = "select r from com.hzih.bsms.domain.RoleUser r where r.roleid=? and r.userid=?";
    ...
    public ArrayList<RoleUser> findRoleUsersByRoleId(int roleid) {
        String hql = "select r from com.hzih.bsms.domain.RoleUser r where r.roleid=?";
    ...
    public ArrayList<RoleUser> findRoleUsersByUserId(int userid) {
        String hql = "select r from com.hzih.bsms.domain.RoleUser r where r.userid=?";
