...
import com.hzih.bsms.dao.UserManageDao;
import com.hzih.bsms.domain.UserManage;
...
public class UserManageDaoImpl extends HibernateDaoSupport implements UserManageDao{
    ...
    public ArrayList<UserManage> findUserManages() {
        String hql = "select t from com.hzih.bsms.domain.UserManage t";
    ...
    public ArrayList<UserManage> findUserManages(final int start, final int limit) {
        final String hql = "select t from com.hzih.bsms.domain.UserManage t order by t.id asc";
    ...
    public ArrayList<UserManage> findUserManageById(int id) {
        String hql = "select t from com.hzih.bsms.domain.UserManage t where t.id=? order by t.id asc";
    ...
    public ArrayList<UserManage> findUserManageByWhere(String coloum, String name) {
        final String hql = "select t from com.hzih.bsms.domain.UserManage t where "+"t."+coloum+" like " + "'%"+name+"%' order by t.id asc";
        ArrayList<UserManage> list = (ArrayList<UserManage>) this.getHibernateTemplate().find(hql);
        return list;
    }
    ...
    public ArrayList<UserManage> findUserManageByCacn(String cacn) {
        String hql = "select t from com.hzih.bsms.domain.UserManage t where t.cacn=? order by t.id asc";
    ...
    public ArrayList<UserManage> findUserManagesByRoleManageId(int roleid) {
        String hql = "select u from com.hzih.bsms.domain.UserManage u,com.hzih.bsms.domain.RoleUser r where u.id=r.userid and r.roleid=?";
    ...
    public ArrayList<UserManage> findUserManagesByRoleManageId(int roleid, final int start,final int limit) {
        final String hql = "select u from com.hzih.bsms.domain.UserManage u,com.hzih.bsms.domain.RoleUser r where u.id=r.userid and r.roleid="+roleid+" order by u.id asc";
        List list = this.getHibernateTemplate().find(hql);
        if( list.size()!=0 ){
            list = getHibernateTemplate().executeFind(
                    new HibernateCallback() {
    ...
    public ArrayList<UserManage> findUserManagesByOtherRoleId(int roleid) {
        String hql = "select u2 from com.hzih.bsms.domain.UserManage u2 where u2.id not in (select u.id from com.hzih.bsms.domain.UserManage u,com.hzih.bsms.domain.RoleUser r where u.id=r.userid and r.roleid=?)";
        ArrayList<UserManage> list = (ArrayList<UserManage>) this.getHibernateTemplate().find(hql, roleid);
        return list;
    }
    ...
    public ArrayList<UserManage> findUserManagesByOtherRoleId(int roleid, final int start,final int limit) {
        final String hql = "select u2 from com.hzih.bsms.domain.UserManage u2 where u2.id not in (select u.id from com.hzih.bsms.domain.UserManage u,com.hzih.bsms.domain.RoleUser r where u.id=r.userid and r.roleid="+roleid+") order by u2.id asc";
        List list = this.getHibernateTemplate().find(hql);
        if( list.size()!=0 ){
            list = getHibernateTemplate().executeFind(
                    new HibernateCallback() {
