...
import com.hzih.bsms.dao.ResourceDao;
import com.hzih.bsms.domain.Resource;
...
public class ResourceDaoImpl extends HibernateDaoSupport implements ResourceDao {
    ...
    public ArrayList<Resource> findResources() {
        String hql = "select t from com.hzih.bsms.domain.Resource t";
    ...
    public ArrayList<Resource> findResources(final int start, final int limit) {
        final String hql = "select t from com.hzih.bsms.domain.Resource t order by t.id asc";
    ...
    public ArrayList<Resource> findResourcesById(int id) {
        String hql = "select t from com.hzih.bsms.domain.Resource t where t.id=?";
    ...
    public ArrayList<Resource> findResourcesByIds(String ids) {
        String hql = "select t from com.hzih.bsms.domain.Resource t where t.id in ("+ids+")";
        ArrayList<Resource> list = (ArrayList<Resource>) this.getHibernateTemplate().find(hql);
        return list;
    }
    ...
    public ArrayList<Resource> findResourcesByName(String name) {
        String hql = "select t from com.hzih.bsms.domain.Resource t where t.name=?";
    ...
    public ArrayList<Resource> findResourcesByLikeName(String name) {
        String hql = "select t from com.hzih.bsms.domain.Resource t where t.name like '%"+name+"%'";
        ArrayList<Resource> list = (ArrayList<Resource>) this.getHibernateTemplate().find(hql);
        return list;
    }
    @Override
    public ArrayList<Resource> findResourcesByLikeName(String name,final int start, final int limit) {
        final String hql = "select t from com.hzih.bsms.domain.Resource t where t.name like '%"+name+"%' order by t.id asc";
        List list = this.getHibernateTemplate().find(hql);
        if( list.size()!=0 ){
            list = getHibernateTemplate().executeFind(
                    new HibernateCallback() {
    ...
    public ArrayList<Resource> findResourcesByTypeAndLikeName(int type, String name) {
        String hql = "select t from com.hzih.bsms.domain.Resource t where t.type="+type+" and t.name like '%"+name+"%'";
        ArrayList<Resource> list = (ArrayList<Resource>) this.getHibernateTemplate().find(hql);
        return list;
    }
    @Override
    public ArrayList<Resource> findResourcesByTypeAndLikeName(int type, String name,final int start, final int limit) {
        final String hql = "select t from com.hzih.bsms.domain.Resource t where t.type="+type+" and t.name like '%"+name+"%' order by t.id asc";
        List list = this.getHibernateTemplate().find(hql);
        if( list.size()!=0 ){
            list = getHibernateTemplate().executeFind(
                    new HibernateCallback() {
    ...
    public ArrayList<Resource> findResourcesByOtherRoleName(String rolename) {
        String hql = "select t from com.hzih.bsms.domain.Resource t where t.name not in (select p.resourcename from com.hzih.bsms.domain.Power p where p.rolename=?)";
    ...
    public ArrayList<Resource> findResourcesByOtherRoleName(String rolename, final int start, final int limit) {
        final String hql = "select t from com.hzih.bsms.domain.Resource t where t.name not in (select p.resourcename from com.hzih.bsms.domain.Power p where p.rolename='"+rolename+"')";
        List list = this.getHibernateTemplate().find(hql);
        if( list.size()!=0 ){
            list = getHibernateTemplate().executeFind(
                    new HibernateCallback() {
    ...
    public ArrayList<Resource> findResourcesByOtherRoleName(String rolename, String name) {
        String hql = "select t from com.hzih.bsms.domain.Resource t where t.name like '%"+name+"%'and"+" t.name not in (select p.resourcename from com.hzih.bsms.domain.Power p where p.rolename=?)";
        ArrayList<Resource> list = (ArrayList<Resource>) this.getHibernateTemplate().find(hql,rolename);
        return list;
    }
    @Override
    public ArrayList<Resource> findResourcesByOtherRoleName(String rolename, String name, final int start, final int limit) {
        final String hql = "select t from com.hzih.bsms.domain.Resource t where t.name like '%"+name+"%'and"+" t.name not in (select p.resourcename from com.hzih.bsms.domain.Power p where p.rolename='"+rolename+"')";
        List list = this.getHibernateTemplate().find(hql);
        if( list.size()!=0 ){
            list = getHibernateTemplate().executeFind(
                    new HibernateCallback() {
    ...
    public ArrayList<Resource> findResourcesByOtherRoleName(String rolename,int type, String name) {
        String hql = "select t from com.hzih.bsms.domain.Resource t where t.type="+type+" and t.name like '%"+name+"%'and"+" t.name not in (select p.resourcename from com.hzih.bsms.domain.Power p where p.rolename=?)";
        ArrayList<Resource> list = (ArrayList<Resource>) this.getHibernateTemplate().find(hql,rolename);
        return list;
    }
    @Override
    public ArrayList<Resource> findResourcesByOtherRoleName(String rolename,int type, String name, final int start, final int limit) {
        final String hql = "select t from com.hzih.bsms.domain.Resource t where t.type="+type+" and t.name like '%"+name+"%'and"+" t.name not in (select p.resourcename from com.hzih.bsms.domain.Power p where p.rolename='"+rolename+"')";
        List list = this.getHibernateTemplate().find(hql);
        if( list.size()!=0 ){
            list = getHibernateTemplate().executeFind(
                    new HibernateCallback() {
    ...
    public ArrayList<Resource> findResourcesByPowerResourceName() {
        String hql = "select r from com.hzih.bsms.domain.Resource r where r.name in(select p.resourcename from com.hzih.bsms.domain.Power p group by p.resourcename)";
        ArrayList<Resource> list = (ArrayList<Resource>) this.getHibernateTemplate().find(hql);
        return list;
    }
