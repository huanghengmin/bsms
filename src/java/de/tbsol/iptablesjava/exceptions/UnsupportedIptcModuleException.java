...
/**
 * This match or target module is not yet supported by iptables-java or is not
 * existing in iptables.
 * 
 * @author Torsten Boob <info@tb-solutions.biz>
 * 
 */
public class UnsupportedIptcModuleException extends Exception {

	private static final long serialVersionUID = 1L;

	public UnsupportedIptcModuleException(String message) {
		super(message);
	}
