 ...
 * {@link jsonrpc2.JSONRPC2Error#INVALID_PARAMS}
 * exception is thrown.
 *
...
public class NamedParamsRetriever 
	 ...
	 *
	 * @throws jsonrpc2.JSONRPC2Error Formatted JSON-RPC 2.0 error.
	 */
	 ...
	 *                       {@code null}.
	 *
	 * @throws jsonrpc2.JSONRPC2Error On a missing parameter name or names outside
	 *                       the specified
	 *                       ({@link jsonrpc2.JSONRPC2Error#INVALID_PARAMS}).
	 */
	 ...
	 *                       empty array or {@code null} if none.
	 *
	 * @throws jsonrpc2.JSONRPC2Error On a missing mandatory parameter name or names
	 ...
	 * @param name The parameter name.
	 *
	 * @throws jsonrpc2.JSONRPC2Error On a missing parameter
	 *                       ({@link jsonrpc2.JSONRPC2Error#INVALID_PARAMS}).
	 */
	 ...
	 *              {@code null}.
	 *
	 * @throws jsonrpc2.JSONRPC2Error On a missing parameter, {@code null} value or
	 *                       bad type ({@link jsonrpc2.JSONRPC2Error#INVALID_PARAMS}).
	 */
	 ...
	 *                  value.
	 *
	 * @throws jsonrpc2.JSONRPC2Error On a missing parameter or bad type
	 *                       ({@link jsonrpc2.JSONRPC2Error#INVALID_PARAMS}).
	 */
	 ...
	 * @return The parameter value.
	 *
	 * @throws jsonrpc2.JSONRPC2Error On a bad parameter type or {@code null} value
	 *                       ({@link jsonrpc2.JSONRPC2Error#INVALID_PARAMS}).
	 */
	 ...
	 * @return The parameter value.
	 *
	 * @throws jsonrpc2.JSONRPC2Error On a bad parameter type
	 *                       ({@link jsonrpc2.JSONRPC2Error#INVALID_PARAMS}).
	 */
	@SuppressWarnings("unchecked")
	 ...
	 *
	 * @throws jsonrpc2.JSONRPC2Error On a missing parameter, bad type or
	 *                       {@code null} value
	 *                       ({@link jsonrpc2.JSONRPC2Error#INVALID_PARAMS}).
	 */
	 ...
	 * @return The parameter value as a string.
	 *
	 * @throws jsonrpc2.JSONRPC2Error On a bad type or {@code null} value
	 *                       ({@link jsonrpc2.JSONRPC2Error#INVALID_PARAMS}).
	 */
	 ...
	 * @return The parameter value as a string.
	 *
	 * @throws jsonrpc2.JSONRPC2Error On a bad type ({@link jsonrpc2.JSONRPC2Error#INVALID_PARAMS}).
	 */
	 ...
	 * @return The parameter value as a string.
	 *
	 * @throws jsonrpc2.JSONRPC2Error On a bad type or bad enumeration value
	 *                       ({@link jsonrpc2.JSONRPC2Error#INVALID_PARAMS}).
	 */
