...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/server/manager_bsms.js"></script>
</head>
<body>
...
<head>
    <title>资源</title>
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/source/bs_source.js"></script>
</head>
