Ext.onReady(function () {
    ...
    var hpcm = new Ext.grid.ColumnModel([
        hpcsm,
        {header:"应用IP", dataIndex:'managerip', width:130},
        {header:"应用端口", dataIndex:'managerport', width:100},
        {header:"服务IP", dataIndex:'proxyip', width:130},
        {header:"服务端口", dataIndex:'proxyport', width:100},
//        {header:"证书站点", dataIndex:'site_name', width:100},
//        {header:"服务器证书站点", dataIndex:'server_site_name', width:100},
        {header:"应用类型", dataIndex:'protocol', width:100,renderer:showProtocol},
                        ...
                        blur:function () {
                            ...
                            if((0<=value&&value<=1024)||value==8000||value ==8080||value == 8443||value==10000||value>=65535){
                                Ext.MessageBox.show({
                                    title:'提示',
                                    width:400,
                                    msg:'0-1024端口可能被系统占用,端口不能为BS应用服务端口8000,8080,8443,且端口不能大于65535!',
...
//    var protocol = recode.get("protocol");
        ...
        Ext.MessageBox.confirm('提示', '是否确定删除这应用', callBack);
