...
//        boxM,
        rowNumber,
        {header:"访问地址", dataIndex:"url",align:'center', sortable:true, menuDisabled:true,sort:true} ,
//       {header:"状态", dataIndex:"status", align:'center',sortable:true, menuDisabled:true,renderer:show_accessAddressStatus},
...
/*    var typeData = [
    ...
    var tbar = new Ext.Toolbar({
        ...
        autoHeight:true,
        items:[
            '访问URL地址', new Ext.form.TextField({
                name : 'url',
