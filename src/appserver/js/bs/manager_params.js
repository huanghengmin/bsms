Ext.onReady(function () {
    ...
    var record = new Ext.data.Record.create([
        ...
        {name:'parent_ip',mapping:'parent_ip'},
        {name:'parent_port',mapping:'parent_port'}
    ...
    store.on('load',function(){
        ...
        Ext.getCmp('parent_port').setValue(store.getAt(0).get('parent_port'));
        Ext.getCmp('parent_ip').setValue(store.getAt(0).get('parent_ip'));
    });
