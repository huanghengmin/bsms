Ext.onReady(function () {
    ...
    var proxy = new Ext.data.HttpProxy({
        url:"../../IPSourceAction_find.action" ,
        timeout: 10*1000
    });
...
//        {header:"标识", dataIndex:"id", align:'center',hidden:true,sortable:true, menuDisabled:true,sort:true} ,
        ...
        {header:"子网掩码", dataIndex:"net", align:'center',sortable:true, menuDisabled:true},
...
function delete_resource() {
    ...
    if(!recode){
        ...
        Ext.Msg.confirm("提示", "确认删除吗？", function(sid) {
            if (sid == "yes") {
                Ext.Ajax.request({
                    url : "../../IPSourceAction_delete.action",
                    timeout: 20*60*1000,
                    method : "POST",
           ...
           /* new Ext.form.TextField({
                ...
                listeners:{
                    blur:function(){
                        ...
                        Ext.Ajax.request({
                            url : '../../IPSourceAction_checkNet.action',
                            timeout: 20*60*1000,
                            method : 'post',
                            params : {
                                url : url
                ...
                handler:function(){
                    if (formPanel.form.isValid()) {
                        formPanel.getForm().submit({
                            url :'../../IPSourceAction_update.action',
                            timeout: 20*60*1000,
                            method :'POST',
                            waitTitle :'系统提示',
                            params:{
